...
def report_post_by_id(reported_post_type, reported_post_id):
    ...
    if len(post_data["reported_post_reason"]) < 3:
        return jsonify({"success": False, "message": "Reason should be atleast three characters long"}), 400
    ...
    if "Attributes" not in result:
        db.put_item(
            ...
            Item={
                ...
                "reported_post_reason": {"S": post_data["reported_post_reason"]}
            }
        )
